      ...
      <div class="row entry">
        <div class="col-xs-12 col-md-5">
          <div class="form-group">
            <label for="validationTooltip06" class="col-sm-6 col-form-label">Nama Barang</label>
            {{-- <select class="form-control selectpicker" id="select-country lstFruits" multiple="multiple" data-live-search="true" name="barangs_id" id="validationTooltip06" aria-label="Default select example"> --}}
              <select class="form-control selectpicker"  data-live-search="true"  name="barangs_id[]" id="validationTooltip06" aria-label="Default select example">
              {{-- <select class="form-select" name="barangs_id" id="validationTooltip06" aria-label="Default select example"> --}}
                <option selected>Pilih Nama Barang</option>
        ...
        <div class="col-md-5">
          <div class="form-group">
            <label for="validationTooltip06" class="col-sm-6 col-form-label">Jumlah item</label>
            <input class="form-control form-control" name="jumlah_pinjam[]" type="number" placeholder=" jumlah item">
          </div>
        </div>
